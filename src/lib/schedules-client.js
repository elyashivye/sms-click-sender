// Thin client for the small scheduling API in server/index.js. The server
// only ever sees a label + timing - never contact lists or message text.
...
export async function createSchedule(serverUrl, password, { label, recurrence }) {
